...
namespace Smart_Home.forms.UserControls
{
    public partial class TvControl : UserControl
    {
        ...
        public TvControl(Furniture Furniture)
        {
        ...
        private void verifyStatus(bool status)
        {
            ...
            else
            {
                ...
                tvLabel.ForeColor = Color.Black;
                onOffLabel.ForeColor = Color.Black;
                onOffLabel.Text = "OFF";
                this.furnitureService.changeStatus(false, furniture.Id);
                if (tvStatus.Checked)
                {
                    tvStatus.Checked = false;
                }

            }
        }

        private void tvStatus_CheckedChanged(object sender, EventArgs e)
        {
            this.verifyStatus(tvStatus.Checked);
        }
    }
}
